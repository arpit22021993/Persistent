  ...
  data () {
    return {
      cards: [
        ...
        {
          image: require('@/assets/grabAndGoWines_paperBackground.png'),
          headline: 'GRAB & GO WINES',
          text: "Whether you're having a backyard barbecue, park picnic or beach day. Woodbridge by Robert Mondavi Grab & Go wines are the perfect pairing.",
          cta: 'EXPLORE SELECTION',
          routerLink: 'grab-and-go',
        },
      ],
    }
  },
...
/deep/ .card {
  ...
  &__image {
    ...
    &-overlay {
      ...
      left: 0;
      height: 10rem;
      //background-image: url(/img/RedPaperTexture-bright-1.d1d70ad9.png);
      top: 207px;
    }
  }
