...
import WineItem from '../our-wines/WineItem'
import WineItemDropDown from '../our-wines/WineItemDropDown'
...
export default {
  ...
  computed: {
    ...mapGetters({
      wines: 'wines/wineList',
    }),
    ...mapState({
      activeWineIndex: state => state.wines.activeWine,
  ...
  methods: {
    ...
    updateActiveWine () {
      this.activeWine = this.wines[this.activeWineIndex]
    },
  },
  components: {
    WineItem,
