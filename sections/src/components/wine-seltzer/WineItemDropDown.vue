  ...
  .wine-item-dropdown.bg(v-show="showDropDown", ref="display")
    ...
    .wine-item-content
      ...
      .icons
        router-link.link.mr(
          to="/where-to-buy",
          :id="'wineseltzer_wtb_' + activeWine.index",
          v-on:keydown.prevent.tab.native="focusEAD",
          v-on:keydown.prevent.shift.tab.native="focusWineBottle"
        ) Where to Buy
        //- router-link to="/eat-and-drink" class="link mr" :id="'wineseltzer_ead_'+activeWine.index" Eat & Drink
        a.instaCartIcon(
          :href="activeWine.instacartLink",
          target="_blank",
          :id="'wineseltzer_insta_' + activeWine.index",
        ...
        a.drizlyIcon(
          ...
          :id="'wineseltzer_drizzly_' + activeWine.index",
          target="_blank",
...
export default {
  ...
  methods: {
    ...
    gotoNextBottleInsta: function () {
      if (
        typeof document.getElementById(
          "wineseltzer_drizzly_" + this.activeWine["index"]
        ) != "undefined" &&
        ...
        if (this.activeWine["index"] != this.wineList.length - 1) {
          ...
          document.getElementById("wineseltzerbottle_" + nextFocus).focus();
        } else {
          document.getElementById("our-wines").focus();
        }
      } else {
        document
          .getElementById("wineseltzer_drizzly_" + this.activeWine["index"])
          .focus();
      }
    },
    ...
    focusInsta: function () {
      ...
      document.getElementById("wineseltzer_insta_" + nextFocus).focus();
    },
    ...
    focusEAD: function () {
      var nextFocus = this.activeWine["index"];
      document.getElementById("wineseltzer_ead_" + nextFocus).focus();
    },
  },
  components: {
    Instacart,
